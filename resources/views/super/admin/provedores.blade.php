            ...
            <div class="super-body">
                <div class="card bg-primary">
                    ...
                    <div class="card-body ps-2 pe-2">
                        <div class="row">
                            <div class="col-4">
                                <div id="input-fantasia" class="form-input light form-input-md">
                                    <label for="fantasia">FANTASIA</label>
                                    <input type="text" id="fantasia" class="form-control" disabled="true">
                                </div>
                            </div>
                            <div class="col-5">
                                <div id="input-titular" class="form-input light form-input-md">
                                    <label for="titular">TITULAR</label>
                                    <input type="text" id="titular" class="form-control" disabled="true">
                                </div>
                            </div>
                            <div class="col-3">
                                <div id="input-ctt-titular" class="form-input light form-input-md">
                        ...
                        <div class="row mt-2">
                            <div class="col-2">
                                <div id="input-cep" class="form-input light form-input-md">
                                    <label for="cep">CEP</label>
                                    <input type="text" id="cep" class="form-control" disabled="true">
                                </div>
                            </div>
                            <div class="col-3">
                                <div id="input-cidade" class="form-input light form-input-md">
                                    <label for="cidade">CIDADE/UF</label>
                                    <input type="text" id="cidade" class="form-control" disabled="true">
                                </div>
                            </div>
                            <div class="col-7">
                                <div id="input-logradouro" class="form-input light form-input-md">
